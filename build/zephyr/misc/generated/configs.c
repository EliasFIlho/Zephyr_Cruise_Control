...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CRUISE_MOTOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ESPRESSIF_ESP32_MCPWM_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ESPRESSIF_ESP32_PCNT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCPWM_ESP32, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCNT_ESP32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PCNT_ESP32_TRIGGER, 1);
